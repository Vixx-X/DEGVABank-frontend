        ...
        <div className="bg-[url('../public/backgroundPage2.png')] bg-cover bg-center grow relative">
          <div className="absolute grow bg-black/60 w-full h-full">
            <div className="max-w-[90%] grid place-items-center mx-auto w-full h-full">
              <div className="rounded mb-4 w-full max-w-[25rem]">
                {success ? (
                  <div className="divide-y">
                    ...
                    <p className="text-light mb-4">
                      Revisa tu correo, te enviamos un link para poder cambiar
                      tu contraseña.
                    </p>
                  </div>
                ) : (
                    ...
                    <Form>
                      <div className="divide-y">
                        ...
                        <div className="pt-4">
                          ...
                          <p className="text-light mb-4">
                            Por favor ingresar su correo electronico. Recibirás
                            via correo un link para crear una nueva contraseña
                          </p>
                        </div>
                      </div>
